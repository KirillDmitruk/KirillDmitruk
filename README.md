...
👨‍💻 Раньше занимался **backend-разработкой на Python**: писал сервисы, интеграции, Telegram-ботов и веб-проекты.  
🤖 Сейчас **перехожу в робототехнику и мехатронику**, работаю с микроконтроллерами, электрикой, сервоприводами и умными устройствами.
...
Актуальный проект по робототехнике:
...
- 💬 Telegram: [@kir_dmitruk](https://t.me/@kir_dmitruk)
...
| Python | C/C++ |
|--------|--------|
| backend и сервисы | Прошивки ESP32/Arduino |
...
| PlatformIO | Arduino IDE | Django / DRF |
|------------|-------------------|---------------|
| Основная среда прошивок | Управление железом | прошлый опыт |
